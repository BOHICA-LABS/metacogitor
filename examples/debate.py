"""Debate between Biden and Trump example"""
# -*- coding: utf-8 -*-
...
from metacogitor.software_company import SoftwareCompany
from metacogitor.actions import Action, BossRequirement
...
class Biden(Role):
    ...
    async def _observe(self) -> int:
        ...
        self._rc.news = [
            ...
            if msg.cause_by == BossRequirement or msg.send_to == self.name
        ]
        return len(self._rc.news)
