...
from metacogitor.const import PROJECT_ROOT, WORKSPACE_ROOT
...
class CreateAgent(Action):
    ...
    PROMPT_TEMPLATE = """
    ### BACKGROUND
    You are using an agent framework called metacogitor to write agents capable of different actions,
    the usage of metacogitor can be illustrated by the following example:
