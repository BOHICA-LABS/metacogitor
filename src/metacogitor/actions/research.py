...
from metacogitor.tools.search_engine import SearchEngine
from metacogitor.tools.web_browser_engine import WebBrowserEngine, WebBrowserEngineType
from metacogitor.utils.common import OutputParser
from metacogitor.utils.text import generate_prompt_chunk, reduce_message_length
...
class CollectLinks(Action):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the action to collect links.

        :param name: The name of the action.
        :type name: str
        :param rank_func: The function to rank the URLs, defaults to None
        :type rank_func: Callable[[list[str]], None], optional
        """
    ...
    async def run(
        ...
        :type topic: str
        :param decomposition_nums: The number of search questions to generate.
        :type decomposition_nums: int
        :param url_per_query: The number of URLs to collect per search question.
        :type url_per_query: int
        :param system_text: The system text.
        :type topic: str
        :return: A dictionary containing the search questions as keys and the collected URLs as values.
        ...
        def gen_msg():
            """Generate the message for the prompt."""
    ...
    async def _search_and_rank_urls(
        ...
        :type query: str
        :param num_results: The number of URLs to collect.
...
class WebBrowseAndSummarize(Action):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the action to browse the web and provide summaries.

        :param browse_func: The function to browse the web, defaults to None
        :type browse_func: Callable[[list[str]], None], optional
        """
    ...
    async def run(
        ...
        *urls: str,
        ...
        :param url: The main URL to browse.
        :type url: str
        :param urls: Additional URLs to browse.
        :type urls: str
        :param query: The research question.
        :type query: str
        :param system_text: The system text.
        :type system_text: str
        :return: A dictionary containing the URLs as keys and their summaries as values.
        :rtype: dict[str, str]
        """
...
class ConductResearch(Action):
    ...
    def __init__(self, *args, **kwargs):
        """Initialize the action to conduct research and generate a research report."""
    ...
    async def run(
        ...
        :param topic: The research topic.
        :type topic: str
        :param content: The content for research.
        :type content: str
        :param system_text: The system text.
        :type system_text: str
...
def get_research_system_text(topic: str, language: str):
    ...
    :param topic: The research topic.
    :type topic: str
    :param language: The language for the system text.
    :type language: str
    :return: The system text for conducting research.
    :rtype: str
    """
