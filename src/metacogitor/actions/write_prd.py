...
class WritePRD(Action):
    """This class is used to write PRD for product."""

    def __init__(self, name="", context=None, llm=None):
        """Initialize the write PRD handler.
    ...
    async def run(
        self, requirements, format=CONFIG.prompt_format, *args, **kwargs
    ) -> ActionOutput:
        """Writes PRD for the given requirements.

        :param requirements: The requirements to write PRD for.
        :type requirements: str
        :param format: The format of the prompt to use. Can be 'markdown' or 'json'.
        :type format: str
        :return: The PRD.
        :rtype: str
        """
