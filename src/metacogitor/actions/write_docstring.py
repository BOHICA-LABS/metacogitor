...
Usage:
    python3 -m metacogitor.actions.write_docstring <filename> [--overwrite] [--style=<docstring_style>]
...
Example:
    python3 -m metacogitor.actions.write_docstring startup.py --overwrite False --style=numpy
...
from metacogitor.utils.pycst import merge_docstring
...
class WriteDocstring(Action):
    ...
    async def run(
        ...
        :type code: str
        :param system_text: A string of system text.
        :type system_text: str
        :param style: A string specifying the style of the docstring. Can be 'google', 'numpy', or 'sphinx'.
        :type style: str
        :return: The Python code with docstrings added.
        :rtype: str
        """
...
def _simplify_python_code(code: str) -> str:
    ...
    :param code: A string of Python code.
    :type code: str
    :return: The simplified Python code.
    :rtype: str
    """
