...
class WriteTasks(Action):
    ...
    def _save(self, context, rsp):
        """Save the tasks to the workspace.

        :param context: Context of the action.
        :param rsp: Response from the action.
        """
        ...
        requirements_path.write_text(
            "\n".join(
                rsp.instruct_content.dict().get("Required Python third-party packages")
            )
        )
