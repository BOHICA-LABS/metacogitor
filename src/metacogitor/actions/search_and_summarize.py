...
class SearchAndSummarize(Action):
    ...
    def __init__(self, name="", context=None, llm=None, engine=None, search_func=None):
        ...
        :param engine: The search engine to use for the action.
        :type engine: str
        :param search_func: The search function to use for the action.
    ...
    async def run(
        ...
        :param system_text: The system text for the action.
