...
class RunCode(Action):
    ...
    async def run_text(cls, code) -> Tuple[str, str]:
        """Run the code in the given text.

        :param code: The code to run.
        :type code: str
        :return: The standard output and standard error of the code.
        :rtype: Tuple[str, str]
        """
    ...
    async def run_script(
        cls, working_directory, additional_python_paths=[], command=[]
    ) -> Tuple[str, str]:
        """Run the given command in a subprocess.

        :param working_directory: The working directory to run the command in.
        :type working_directory: str
        :param additional_python_paths: Additional paths to add to the PYTHONPATH environment variable.
        :type additional_python_paths: list[str]
    ...
    async def run(
        ...
        **kwargs,
        ...
        :param code: The code to run.
        :type code: str
        :param mode: The mode to run the code in. Can be "script" or "text".
        :type mode: str
        :param code_file_name: The name of the file containing the code.
        :type code_file_name: str
        :param test_code: The test code to run.
        :type test_code: str
        :param test_file_name: The name of the file containing the test code.
