...
You can use the functions provided by the public library metacogitor, but can't use functions from other third-party libraries. The public library is imported as variable x by default.
- `import metacogitor as x`
