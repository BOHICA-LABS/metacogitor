"""Tutorial assistant Module."""
# _*_ coding: utf-8 _*_

from datetime import datetime
from typing import Dict

from metacogitor.actions.write_tutorial import WriteDirectory, WriteContent
from metacogitor.const import TUTORIAL_PATH
from metacogitor.logs import logger
from metacogitor.roles import Role
from metacogitor.schema import Message
from metacogitor.utils.file import File
...
class TutorialAssistant(Role):
    ...
    async def _handle_directory(self, titles: Dict) -> Message:
        ...
        Args:
        :param titles: A dictionary containing the titles and directory structure,
                    such as {"title": "xxx", "directory": [{"dir 1": ["sub dir 1", "sub dir 2"]}]}
        :type titles: Dict
        :return: A message containing information about the directory.
        :rtype: Message
        """
    ...
    async def _act(self) -> Message:
        ...
        :return: A message containing the result of the action.
        :rtype: Message
        """
        todo = self._rc.todo
    ...
    async def _react(self) -> Message:
        ...
        :return: A message containing the final result of the assistant's actions.
        :rtype: Message
        """
