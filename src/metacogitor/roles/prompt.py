...
class PromptString(Enum):
    ...
    Attributes:
        RESEARCH_SUMMARY (str): The research summary prompt string.
        RESOURCE_REPORT (str): The resource report prompt string.
        OUTLINE_REPORT (str): The outline report prompt string.
        CONCEPTS (str): The concepts prompt string.
        LESSON (str): The lesson prompt string.
        REFLECTION_QUESTIONS (str): The reflection questions prompt string.
        REFLECTION_INSIGHTS (str): The reflection insights prompt string.
        IMPORTANCE (str): The importance prompt string.
        RECENT_ACTIVITY (str): The recent activity prompt string.
        MAKE_PLANS (str): The make plans prompt string.
        EXECUTE_PLAN (str): The execute plan prompt string.
        REACT (str): The react prompt string.
        GOSSIP (str): The gossip prompt string.
        HAS_HAPPENED (str): The has happened prompt string.
        OUTPUT_FORMAT (str): The output format prompt string.
    """
