...
async def mermaid_to_file(
    ...
    :param width: The width of the output image in pixels. Defaults to 2048.
    :type width: int
    :param height: The height of the output image in pixels. Defaults to 2048.
    :type height: int
    :return: Returns 1 if the conversion and saving were successful, -1 otherwise.
    :rtype: int
    """
