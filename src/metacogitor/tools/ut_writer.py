"""Unit Test Generator: Construct UT through API documentation"""
# -*- coding: utf-8 -*-

import json
from pathlib import Path

from metacogitor.provider.openai_api import OpenAIGPTAPI as GPTAPI
...
class UTGenerator:
    ...
    def __init__(
        ...
        :param swagger_file: path to the swagger file
        :type swagger_file: str
        :param ut_py_path: path to store test cases
        :type ut_py_path: str
        :param questions_path: path to store the template, facilitating subsequent checks
        :type questions_path: str
        :param chatgpt_method: API method
        :type chatgpt_method: str
        :param template_prefix: use the template, default is YFT_UT_PROMPT
    ...
    def __para_to_str(self, prop, required, name=""):
        ...
        :type prop: dict
        :param required: whether it's a required field
        :type required: bool
        :param name: parameter name, defaults to ""
    ...
    def para_to_str(self, name, prop, prop_object_required):
        ...
        :param prop: parameter
        :type prop: dict
        :param prop_object_required: whether it's a required field
        :type prop_object_required: dict
        :return: parameter string
        :rtype: str
        """
    ...
    def build_object_properties(
        ...
        :param node: value of the child item
        :type node: dict
        :param prop_object_required: whether it's a required field
        :type prop_object_required: dict
        :param level: current recursion depth
        :type level: int
        :return: properties of object and array[object] types
        :rtype: str
        """
    ...
    def get_tags_mapping(self) -> dict:
        ...
        :return: Dict: mapping of tag to path
        :rtype: dict
        """
    ...
    def generate_ut(self, include_tags) -> bool:
        ...
        :param include_tags: tags to include
