...
class GPTPromptGenerator:
    ...
    def gen_instruction_style(self, example):
        ...
        :return: Expected LLM input sample
        """
...
What are the {step} fundamental steps to consider when attempting to {question}?"""
    ...
    def gen(self, question: str, step: str) -> list[str]:
        """Generate a prompt for the given question and step.

        :param question: The question to generate the prompt for.
        :type question: str
        :param step: The step to generate the prompt for.
        :type step: str
        :return: The prompt for the given question and step.
        :rtype: list[str]
        """
...
Can you send me an email about {subj}?"""
    ...
    def gen(self, subj):
        """Generate a prompt for the given subject.

        :param subj: The subject to generate the prompt for.
        :type subj: str
        :return: The prompt for the given subject.
        :rtype: list[str]
        """
